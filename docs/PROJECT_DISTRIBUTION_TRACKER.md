...
| 2026-07-17 | GitHub directory | Picrew/awesome-agent-harness | Reviewed contribution gate and prepared target-specific draft | READY_FOR_SUBMISSION | https://github.com/Picrew/awesome-agent-harness | Await target-specific owner authorization; no PR created | After authorization or target policy change |

## Status vocabulary

`CANDIDATE`, `REJECTED_MISMATCH`, `READY_FOR_SUBMISSION`, `SUBMITTED`, `ACCEPTED`, `DECLINED`, `PREPARED_NOT_POSTED`, and `POSTED` describe workflow state only. They do not imply endorsement, adoption, or production readiness.
